...
describe("demonstrate how to extrude a face",function() {
    ...
    it("extrudeFace",function() {
        ...
        var  aPnt3 = [  10 ,  9.0 , 0];
        var  aPnt4 = [   0 , 10.0 , 0];
        var aSegment1 = new occ.makeLine(aPnt1, aPnt2);
        var aSegment2 = new occ.makeLine(aPnt2, aPnt3);
        var aSegment3 = new occ.makeLine(aPnt3, aPnt4);
        var aSegment4 = new occ.makeLine(aPnt4, aPnt1);
