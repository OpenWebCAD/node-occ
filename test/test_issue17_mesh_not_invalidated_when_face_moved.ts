...
describe("issue#17 testing that mesh get invalidated ", function () {
    ...
    function constructFaceWithWire() {
        ...
        const segment1 = occ.makeLine(aPnt1, aPnt2);
        const segment2 = occ.makeLine(aPnt2, aPnt3);
        const segment3 = occ.makeLine(aPnt3, aPnt4);
        const segment4 = occ.makeLine(aPnt4, aPnt1);

        const wire = occ.makeWire(segment1, segment2, segment3, segment4);
