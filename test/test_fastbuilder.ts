import { occ, fastBuilder, ISolid, shapeFactory } from "..";
import "should";

const fast_occ = fastBuilder;
...
function stopChronometer(time1: [number, number]) {
...
describe("testing fast builder with some built-in shapes", function () {
    ...
    it("should  create the  bottle..", function () {
        let s1 = shapeFactory.makeBottle(fastBuilder, { filletRadius: 1, height: 100 });
...
describe("testing fast builder with some shapes", function () {
    ...
    it("should  create the  piston..", function () {
        ...
        let s1 = shapeFactory.makePiston(fastBuilder);
...
describe("testing fast-builder with LEGO brick", function () {
    ...
    it("should produce a LEGO brick", function () {
        ...
        function buildBrick() {
            ...
            let nx = 3;
            let ny = 6;
            let brick24 = shapeFactory.makeLegoBrick(fast_occ, nx, ny, "thick");
