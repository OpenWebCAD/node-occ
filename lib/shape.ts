...
export function init(occ: OCC) {
    ...
    occ.buildSolidMeshNew = (solid: ISolid) => {
        ...
        function makeEdgesIndexes(solid: ISolid, jsonSolidMesh: IMesh2) {
            ...
            let indexes: Uint8Array | Uint16Array | Uint32Array | undefined = undefined;
        ...
        function toBase64(typedArray: TypedArray | number[] | Triplet[]): Base64EncodingBuffer {
            const a = [];
    ...
    occ.buildSolidMesh = function (solid: ISolid) {
        ...
        const jsonSolidMesh: IMesh2 = { version: "", name: solid.name, vertices: [], faces: [], edges: [], normals: [] };
        let i;
