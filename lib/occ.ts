...
export class EdgeIterator extends _ShapeIterator implements IShapeIterator<IEdge> {
...
export class FaceIterator extends _ShapeIterator implements IShapeIterator<IFace> {
